-- Update current user to admin role and create comprehensive test data
...
(150.00, 'registration_fee', 'Competition registration fee - Test Transaction', CURRENT_DATE, 'completed', auth.uid()),
(75.00, 'equipment', 'Equipment maintenance - Test Transaction', CURRENT_DATE - INTERVAL '5 days', 'completed', auth.uid()),
...
INSERT INTO public.notifications (sender_id, title, message, notification_type) VALUES
(auth.uid(), 'Welcome to Test Club', 'This is a test notification for the club management system', 'general'),
(auth.uid(), 'Training Session Reminder', 'Reminder: Training session tomorrow at 9:00 AM', 'training');