...
-- Insert awards for top athletes
INSERT INTO awards (athlete_id, award_name, award_type, award_date, points_earned)
VALUES
((SELECT id FROM athletes WHERE athlete_number = 'ATH012'), 'Medalla de Oro', 'gold', '2024-06-12', 100),
((SELECT id FROM athletes WHERE athlete_number = 'ATH016'), 'Medalla de Oro', 'gold', '2024-06-12', 100),
((SELECT id FROM athletes WHERE athlete_number = 'ATH017'), 'Medalla de Oro', 'gold', '2024-06-12', 100),
((SELECT id FROM athletes WHERE athlete_number = 'ATH007'), 'Medalla de Plata', 'silver', '2024-06-12', 80),
((SELECT id FROM athletes WHERE athlete_number = 'ATH014'), 'Medalla de Plata', 'silver', '2024-06-12', 80),
((SELECT id FROM athletes WHERE athlete_number = 'ATH008'), 'Medalla de Bronce', 'bronze', '2024-06-12', 60),
((SELECT id FROM athletes WHERE athlete_number = 'ATH011'), 'Medalla de Bronce', 'bronze', '2024-06-12', 60),
((SELECT id FROM athletes WHERE athlete_number = 'ATH013'), 'Medalla de Bronce', 'bronze', '2024-06-12', 60);