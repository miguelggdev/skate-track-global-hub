        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800 px-3 py-2 mb-3 flex items-center gap-2">
                  <span className="text-amber-600 dark:text-amber-400 text-xs font-medium">
                    Datos de ejemplo — montos hardcodeados para ilustración
                  </span>
                </div>
